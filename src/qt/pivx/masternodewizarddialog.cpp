    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 19324");
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("19328");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("19326");
    } else {
        ui->lineEditPort->setText("19324");
    }
...
bool MasterNodeWizardDialog::createMN()
{
    if (walletModel) {
        ...
        SendCoinsRecipient sendCoinsRecipient(QString::fromStdString(address.ToString()), QString::fromStdString(alias), CAmount(500000) * COIN, "");
            ...
            if (boost::filesystem::exists(pathBootstrap)) {
                ...
                if (lineCopy.size() == 0) {
                    lineCopy = "# Masternode config file\n"
                               ...
                               "# Example: mn1 127.0.0.2:19324 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0"
                               "#";
                }
                lineCopy += "\n";
