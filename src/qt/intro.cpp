...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("eXperience Points Core"),
     ...
     * override -datadir in the eXperiencePoints.conf file in the default data directory
     * (to be consistent with eXperiencePointsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
