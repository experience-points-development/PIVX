                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("eXperience Points Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an eXperience Points address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xp: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About eXperience Points Core"), this);
    aboutAction->setStatusTip(tr("Show information about eXperience Points Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for eXperience Points"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your eXperience Points addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified eXperience Points addresses"));
    ...
    openAction->setStatusTip(tr("Open a XP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the eXperience Points Core help message to get a list with possible eXperience Points command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("eXperience Points Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to eXperience Points network", "", count));
}
...
{
    QString strTitle = tr("eXperience Points Core"); // default title
