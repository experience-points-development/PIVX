...
/** Utility functions used by the eXperience Points Qt UI.
 */
namespace GUIUtil
{
...
// Render XP addresses in monospace font
...
// Parse "xp:" URI into recipient object, return true on successful parsing
