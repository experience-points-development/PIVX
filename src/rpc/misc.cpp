...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total XP balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zXPsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zXP denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zXP denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zXP denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zXP denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zXP denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zXP denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zXP denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zXP denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zXP denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in XP/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in XP/kb\n"
    ...
    obj.push_back(Pair("zXPsupply", zpivObj));
...
#ifdef ENABLE_WALLET
        // Case 1: XP address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw runtime_error(
            ...
            HelpExampleCli("createmultisig", "2 \"[\\\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\\\",\\\"PXUaUNWYdQeHAkshWKfnSfMAWx99eDAVnn\\\"]\"") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("createmultisig", "2, \"[\\\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\\\",\\\"PXUaUNWYdQeHAkshWKfnSfMAWx99eDAVnn\\\"]\""));
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nAs json rpc\n" +
            HelpExampleRpc("verifymessage", "\"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\", \"signature\", \"my message\""));
