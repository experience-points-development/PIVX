...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            ...
            "5. \"address\":   (string, required) Address to send payments to\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://www.experiencepoints.io\" 2 820800 \"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://www.experiencepoints.io\" 2 820800 \"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\" 500"));
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://www.experiencepoints.io\" 2 820800 \"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://www.experiencepoints.io\" 2 820800 \"PQ72SjLCNR1HCwsXRrEJWNgAkAFe11sWTx\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) Address of payment\n"
